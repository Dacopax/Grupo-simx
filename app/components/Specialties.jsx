...
export default function Specialties() {
    return (
        <section id="specialties" className="relative bg-[#044D57] overflow-hidden border-t border-white/5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 min-h-0 lg:min-h-[800px] relative z-10">
                ...
                <motion.div
                    ...
                    className="relative bg-gradient-to-br from-[#086775] via-[#075A66] to-[#044D57] p-8 sm:p-12 md:p-16 lg:p-24 flex flex-col justify-center overflow-hidden border-r border-white/5"
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <h2 className="text-white font-header font-black text-4xl sm:text-5xl md:text-8xl tracking-tighter leading-[0.85] mb-12 uppercase">
                            Ingeniería de <br />
                        ...
                        <p className="text-turquoise-100/40 font-body text-sm sm:text-base md:text-2xl leading-relaxed max-w-xl italic font-light">
                ...
                <motion.div
                    ...
                    className="p-6 sm:p-8 md:p-12 lg:p-20 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 bg-[#022C32]/50 backdrop-blur-3xl"
                >
                    {specialties.map((spec, index) => (
                        ...
                        >
                            ...
                            <div className="w-full p-6 sm:p-8 md:p-10 rounded-[2rem] sm:rounded-[3rem] bg-white/[0.03] border border-white/5 group-hover:border-turquoise-400/20 group-hover:bg-white/[0.05] transition-all duration-700 h-full flex flex-col">
                                <div className="flex items-center justify-between mb-6 sm:mb-8">
                                    <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-2xl bg-white/5 flex items-center justify-center border border-white/10 group-hover:bg-turquoise-500 group-hover:border-turquoise-400 transition-all duration-500">
                                ...
                                <h3 className="font-header font-black text-base sm:text-lg md:text-xl text-white mb-3 sm:mb-4 uppercase tracking-tighter group-hover:text-turquoise-200 transition-colors leading-tight">
                                    {spec.label}
                                </h3>
                                
                                <p className="text-turquoise-100/30 font-body text-xs sm:text-sm leading-relaxed italic font-light line-clamp-3">
                                    {spec.desc}
                                </p>
